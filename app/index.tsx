  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <FlatList data={[...todos]. reverse()} 
               ...
               renderItem={({item})=> <ToDoItem todo={item} deleteTodo={deleteTodo} handleDone={handleDone}/>}/>
              <KeyboardAvoidingView style={styles.footer} 
              behavior="padding" 
              keyboardVerticalOffset={10}>
                <TextInput placeholder="Add new task" placeholderTextColor="#555" 
                value={todoText} 
...
const styles= StyleSheet.create({
  ...
  searchBar:{
    ...
    padding:16,
    borderRadius: 10, 
    gap:10, //uske child components ke beech ka gap
    marginBottom: 20
  },
  searchInput:{
    flex:1,
